        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                @auth
                    ...
                    @can('create', App\Models\Vacante::class)
                        <a class="mr-2 w-7 bg-indigo-600 hover:bg-indigo-800 rounded-full flex flex-col justify-center items-center text-sm font-extrabold text-white" href="{{ route('notificaciones') }}">
                ...
                <x-responsive-nav-link :href="route('vacantes.create')" :active="request()->routeIs('vacantes.create')">
                    ...
                    @if (auth()->user()->rol === 2)
                        <div class="flex gap-2 items-center p-3">
                            ...
                            <a class="w-7 bg-indigo-600 hover:bg-indigo-800 rounded-full flex flex-col justify-center items-center text-sm font-extrabold text-white" href="{{ route('notificaciones') }}">
                                {{ auth()->user()->unreadNotifications->count() }}
                            </a>
